...
if __name__ == '__main__':
	...
	for email_id, raw_email_datum in raw_unread_email_data:
		...
		# MAKE EMAIL OBJECT
		newemail = error_harness(seen_email_data, unused_voters, ids_to_mark_read, new_email.NewEmail, email_id,
		...
		print("Returned handler: {0}".format(handler))
		print("is_expected: {0}".format(is_expected))
